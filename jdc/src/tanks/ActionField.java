...
public class ActionField extends JPanel {
	...
	public void processMove(Tank tank) throws Exception {
		...
		while (covered < 64) {
			if (direction == 1) {
				tank.updateY(-step);
				System.out.println("Move Up direction " + direction + " tank X " + tank.getX() + " tank Y "
						+ tank.getY());
			} else if (direction == 2) {
				tank.updateY(step);
				System.out.println("Move Up direction " + direction + " tank X " + tank.getX() + " tank Y "
	...
	public ActionField() throws Exception {
		...
		frame.setMinimumSize(new Dimension(battleField.getBfWidth() + 12, battleField.getBfHeight() + 38));
